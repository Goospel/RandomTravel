...
//
// Vercel Cron(0 23 * * * UTC = KST 08시)이 GET 으로 호출한다. 집중률·빅데이터(방문자수)는 공사 쪽에서
// 매일 07:30 이후 갱신되므로 그 뒤에 당겨야 당일치가 잡힌다(공사 회신 2026-07-29 — 이전 KST 06시는
// 갱신 전이라 하루 묵은 데이터를 받고 있었다). 뽑기·후보 수 요청 경로는 DB 조회만
